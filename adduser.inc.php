...

{
   ...
   $query = "INSERT into customer (customer_email, customer_password, customer_fname, customer_lname, customer_phone) VALUES (?,?,?,?,?);";
   //Prepared statement
   ...
   if (!mysqli_stmt_prepare($stmt, $query))   {
	   ...
	   mysqli_stmt_bind_param($stmt, "sssss", $customer_email, $hashed, $customer_fname,$customer_lname, $customer_phone );
	   //Run parameters inside dba_close
